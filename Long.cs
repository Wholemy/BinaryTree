	...
	public static partial class Map {
...
#endif
		#endregion
		public static bool Add<T>(ref Long<T> Owner, long Index) {
			return Long<T>.Add(ref Owner, Index);
		}
		#endregion
...
#endif
		#endregion
		public static bool Add<T>(ref Long<T> Owner, long Index, T Value) {
			return Long<T>.Add(ref Owner, Index, Value);
		}
		#endregion
...
#endif
		#endregion
		public static bool Put<T>(ref Long<T> Owner, long Index, T Value) {
			return Long<T>.Put(ref Owner, Index, Value);
		}
		#endregion
...
#endif
		#endregion
		public static bool Set<T>(ref Long<T> Owner, long Index, T Value) {
			return Long<T>.Set(ref Owner, Index, Value);
		}
		#endregion
...
#endif
		#endregion
		public static bool Get<T>(ref Long<T> Owner, long Index, ref T Value) {
			var O = Owner;
			if (O != null) {
				O = O.Get(Index);
				if (O != null) {
...
#endif
		#endregion
		public static bool Get<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.Get(Index);
				if (O != null) {
...
#endif
		#endregion
		public static bool GetA<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index);
				if (O != null) {
...
#endif
		#endregion
		public static bool GetA<T>(ref Long<T> Owner, long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index);
...
#endif
		#endregion
		public static bool GetAE<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
...
#endif
		#endregion
		public static bool GetAE<T>(ref Long<T> Owner, long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index, true);
				if (O != null && O.Index <= Limit) {
...
#endif
		#endregion
		public static bool GetB<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index);
				if (O != null) {
...
#endif
		#endregion
		public static bool GetB<T>(ref Long<T> Owner, long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index);
				if (O != null && O.Index >= Limit) {
...
#endif
		#endregion
		public static bool GetBE<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
...
#endif
		#endregion
		public static bool GetBE<T>(ref Long<T> Owner, long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index, true);
				if (O != null && O.Index >= Limit) {
...
#endif
		#endregion
		public static T GetV<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.Get(Index);
				if (O != null) {
...
#endif
		#endregion
		public static T GetVA<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index);
				if (O != null) {
...
#endif
		#endregion
		public static T GetVA<T>(ref Long<T> Owner, ref long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index);
				if (O != null) {
...
#endif
		#endregion
		public static T GetVA<T>(ref Long<T> Owner, long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index);
				if (O != null && O.Index <= Limit) {
...
#endif
		#endregion
		public static T GetVA<T>(ref Long<T> Owner, ref long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index);
				if (O != null && O.Index <= Limit) {
...
#endif
		#endregion
		public static T GetVAE<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index, true);
				if (O != null) {
...
#endif
		#endregion
		public static T GetVAE<T>(ref Long<T> Owner, ref long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index, true);
				if (O != null) {
...
#endif
		#endregion
		public static T GetVAE<T>(ref Long<T> Owner, long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index, true);
				if (O != null && O.Index <= Limit) {
...
#endif
		#endregion
		public static T GetVAE<T>(ref Long<T> Owner, ref long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetAbove(Index, true);
				if (O != null && O.Index <= Limit) {
...
#endif
		#endregion
		public static T GetVB<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index);
				if (O != null) {
...
#endif
		#endregion
		public static T GetVB<T>(ref Long<T> Owner, ref long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index);
				if (O != null) {
...
#endif
		#endregion
		public static T GetVB<T>(ref Long<T> Owner, long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index);
				if (O != null && O.Index >= Limit) {
...
#endif
		#endregion
		public static T GetVB<T>(ref Long<T> Owner, ref long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index);
				if (O != null && O.Index >= Limit) {
...
#endif
		#endregion
		public static T GetVBE<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index, true);
				if (O != null) {
...
#endif
		#endregion
		public static T GetVBE<T>(ref Long<T> Owner, ref long Index) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index, true);
				if (O != null) {
...
#endif
		#endregion
		public static T GetVBE<T>(ref Long<T> Owner, long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index, true);
				if (O != null && O.Index >= Limit) {
...
#endif
		#endregion
		public static T GetVBE<T>(ref Long<T> Owner, ref long Index, long Limit) {
			var O = Owner;
			if (O != null) {
				O = O.GetBelow(Index, true);
				if (O != null && O.Index >= Limit) {
...
#endif
		#endregion
		public static bool CutA<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.Get(Index);
				if (O != null) {
...
#endif
		#endregion
		public static bool CutB<T>(ref Long<T> Owner, long Index) {
			var O = Owner;
			if (O != null) {
				O = O.Get(Index);
				if (O != null) {
		...
		public class Long<T> {
...
#endif
			#endregion
			public Long(long Index, T Value) {
				this.Shift = 0;
				this.Index = Index;
				this.count = 1;
				this.value = Value;
...
#endif
			#endregion
			private Long(Long<T> Old, Long<T> New) {
...
#endif
			#endregion
			public static bool Add(ref Long<T> Owner, long Index) {
				var O = Owner;
				if (O == null) { Owner = new Long<T>(Index); return true; }
...
#endif
			#endregion
			public static bool Put(ref Long<T> Owner, long Index, T Value) {
				var O = Owner;
				if (O == null) { Owner = new Long<T>(Index, Value); return true; }
				while (O.owner != null && O.Index != Index >> O.Shift) { O = O.owner; }
				while (O != null) {
...
#endif
			#endregion
			public Long<T> GetAbove(long Index, bool Equal = false) {
				var T = this;
				Long<T> A = null;
				while (T.owner != null && T.Index != Index >> T.Shift) { T = T.owner; }
				while (T != null) {
...
#endif
			#endregion
			public Long<T> GetBelow(long Index, bool Equal = false) {
				var T = this;
				Long<T> B = null;
				while (T.owner != null && T.Index != Index >> T.Shift) { T = T.owner; }
				while (T != null) {
			...
			public Long<T> Cut() {
				...
				Long<T> Other, Owner, Cuted = T.owner;
				if (Cuted != null) {
					var Below = T.below;
					var Above = T.above;
